...
if [[ ${OS} == "windows" ]]; then
    ...
    make check
        ...
        #   * runs the soteriad unit tests in src/test/test_soteria
        #   * runs the soteria-qt unit tests in src/qt/test/test_main
        #   * runs "test/util/soteria-util-test.py" which checks soteria-tx
