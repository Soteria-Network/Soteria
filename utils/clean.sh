...
rm -f src/config/soteria-config.h
...
rm -rf test_soteria.coverage/ soteria-gtest.coverage/ total.coverage/
...
clean_exe src/soteria-cli
clean_exe src/soteriad
clean_exe src/soteria-gtest
clean_exe src/soteria-tx
clean_exe src/test/test_soteria
clean_exe src/test/test_soteria_fuzzy
...
clean_dep . src/config/soteria-config.h.in
