...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure soteriad isn't accepting b26
        ...
        # Extend the b28 chain to make sure soteriad isn't accepting b28
        ...
        #
        # Soteria: Currently this causes a node disconnect, and I'm not even sure that's wrong.
