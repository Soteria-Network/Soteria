...
#
# NodeConn: an object which manages p2p connectivity to a Soteria node
...
COIN = 100000000 # mlumin 5/2021: In terms of Soter, 1 soter or 100,000,000 koinu.
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest", services=NODE_NETWORK, send_version=True):
        ...
        print('MiniNode: Connecting to Soteria Node IP # ' + dstaddr + ':' \
            + str(dstport))
