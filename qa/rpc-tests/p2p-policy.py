...
class P2PPolicyTests(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # Soteria Core node that behaves similar to mainnet policies
    ...
    def run_test(self):
        ...
        ### test constants ###
        koinu = Decimal("0.00000001")          # 1 Koinu expressed in SOTER
        ten = Decimal("10.0")                  # uniform 10 SOTER seed moneys
        ...
        # create a bunch of UTXO with seed money from the Soteria Core wallet
        for i in range(20):
        ...
        # test legacy output of 1 SOTER output and 1 SOTER fee
    ...
    # spend seed money with a key not in the Soteria Core wallet.
    def spend_utxo(self, output, expected_size, retries=0):
        # construct the transaction using Soteria Core raw tx APIs
        ...
        # and send the tx from there rather than from Soteria Core, to test
