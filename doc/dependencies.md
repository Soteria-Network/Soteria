...
These are the dependencies currently used by Soteria Core. You can find instructions for installing them in the `build-*.md` file for your platform.
...
| libICE    | 1.0.9  | | | | |
| libjpeg |  |  |  |  | [Yes](https://github.com/SoteriaNetwork/Soteria/blob/master/depends/packages/qt.mk#L75) |
| libpng |  |  |  |  | [Yes](https://github.com/SoteriaNetwork/Soteria/blob/master/depends/packages/qt.mk#L74) |
| libtapi    |   | | | | |
| libSM    | 1.2.2  | | | | |
| libX11    | 1.6.2  | | | | |
| libXau    | 1.0.8  | | | | |
...
| PCRE |  |  |  |  | [Yes](https://github.com/SoteriaNetwork/Soteria/blob/master/depends/packages/qt.mk#L76) |
