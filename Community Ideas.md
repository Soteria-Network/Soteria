# Soteria Network - Community Ideas

**NOTE:** These ideas are originally from the Ravencoin community.

We’re all in this together. Join in and build something. This is not an exhaustive list, but just a starting point to fire the imagination.
...
- Core
  - Asset Exchange Proxy (simulate sending an ASSET)
...
- Run a contest: Soter prize for best idea for new Soteria based Business
...
- Back-end API platform for Soteria
  - Other people to hit high-availablity API
- Fee system to pay Soter fees automatically
  - Auto-pay fees
  - Can take X% of fees
...
- Auto fee funder (so users of ABC token doesn’t need to worry about fees)
  ...
  - Sends small amount of Soter for fees.
- #BLUE_CHECK_MARK tag issuer as a trust mark. Not just KYC, but a history of being a good actor. Mirrors the blue check mark from X platform.
- #KYC tagger - store info and tag Soteria addresses
- #ACCREDITED - verify accredited status and tag Soteria addresses

### Technical Consultant

- Help companies apply Soteria capabilities to real-world problems
- Security Token Issuance Platform
- Collaborate with exchanges for more listings
- Collaborate with custodial Security Token exchanges for deposit/withdrawal
- Collaborate with hardware wallets for additional Soter and asset support

### Areas for Soteria Innovation
