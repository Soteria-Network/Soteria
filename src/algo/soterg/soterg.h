...
// SoterG-lite v1
template<typename T1>
inline uint256 HashXSGL(const T1 pbegin, const T1 pend, const uint256 PrevBlockHash)
{
    static unsigned char pblank[1];
    uint512 hash[4];
...
// SoterG-lite v2
template<typename T1>
inline uint256 HashXSGLV2(const T1 pbegin, const T1 pend, const uint256 PrevBlockHash)
{
    static unsigned char pblank[1];
    uint512 hash[6];
...
template<typename T1>
inline uint256 HashX12ST(const T1 pbegin, const T1 pend, const uint256 PrevBlockHash)
{
    static unsigned char pblank[1];
    uint512 hash[12];
    ...
    for (int i = 0; i < 12; i++)
    {
        ...
        switch (i)
        {
            case 0: // Step 1: FUGUE (80-bit)
            case 1: // Step 2: FUGUE (64-bit)
            {
