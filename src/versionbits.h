...
#ifndef SOTERIA_CONSENSUS_VERSIONBITS
#define SOTERIA_CONSENSUS_VERSIONBITS
...
static constexpr int32_t VERSIONBITS_TOP_BITS_ASSETS = 0x30000000UL;
/** What bitmask determines whether versionbits is in use */
static constexpr int32_t VERSIONBITS_TOP_MASK = 0xE0000000UL;
/** Total bits available for versionbits */
static constexpr int32_t VERSIONBITS_NUM_BITS = 16; // Dual algo: Only consider bottom 16 bits for UASF voting
enum ThresholdState {
    THRESHOLD_DEFINED,
    THRESHOLD_STARTED,
    THRESHOLD_LOCKED_IN,
