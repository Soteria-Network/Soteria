...
static UniValue getnetworkhashps(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "3. powalgo     (string, optional) This can be set to \"soterc\" or \"soterg\". If omitted, wallet's default is assumed (-powalgo conf option)\n" // LitecoinCash: SoterC
            "\nResult:\n"
...
UniValue getblocktemplate(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "     {\n"
            "       \"powalgo\":\"xxxx\"     (string, optional) This can be set to \"soterg\" or \"soterC\". If omitted, wallet's default is assumed (-powalgo conf option)\n"
