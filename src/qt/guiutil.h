...
#ifndef SOTERIA_QT_GUIUTIL_H
#define SOTERIA_QT_GUIUTIL_H
...
/** Utility functions used by the Soteria Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "soteria:" URI into recipient object, return true on successful parsing
