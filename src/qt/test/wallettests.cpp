...
#include "qt/soteriaamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<SoteriaAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_soteria-qt -platform xcb      # Linux
//     src/qt/test/test_soteria-qt -platform windows  # Windows
//     src/qt/test/test_soteria-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = SoteriaUnits::formatWithUnit(unit, balance, false, SoteriaUnits::separatorAlways);
    ...
    // Amount input
    SoteriaAmountField* amountInput = receiveCoinsDialog.findChild<SoteriaAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: soteria:")) != -1);
