...
void RPCConsole::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to SoteriaGUI::handleRestart()
...
void RPCConsole::clear(bool clearHistory)
{
    ...
    for(int i=0; ICON_MAPPING[i].url; ++i)
    {
        ui->messagesWidget->document()->addResource(
                    ...
                    platformStyle->SingleColorImage(ICON_MAPPING[i].source,COLOR_SOTERIA_2B737F).scaled(QSize(consoleFontSize*2, consoleFontSize*2), Qt::IgnoreAspectRatio, Qt::SmoothTransformation));
    }
