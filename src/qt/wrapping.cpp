...
void WrapPage::wrapped_clicked()
{
    ...
    msgBox.setText("Wrapped Soteria is NOT managed by Soteria Core and is run by a 3rd party. We are not responsible for any coin LOSS. By using this feature, you must understand the RISK.");
