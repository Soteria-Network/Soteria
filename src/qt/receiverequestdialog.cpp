...
#include "config/soteria-config.h" /* for USE_QRCODE */
#endif
...
void QRImageWidget::mousePressEvent(QMouseEvent *event)
{
    if(event->button() == Qt::LeftButton && GUIUtil::HasPixmap(this))
    {
        ...
        // Add preview to QR code drag and drop. Tab replaced with spaces to fit layout
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatSoteriaURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + SoteriaUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatSoteriaURI(info));
}
