...
#ifndef SOTERIA_QT_OPTIONSMODEL_H
#define SOTERIA_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Soteria client.
...
#endif // SOTERIA_QT_OPTIONSMODEL_H
