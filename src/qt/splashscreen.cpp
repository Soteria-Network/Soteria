...
//  QFontDatabase::addApplicationFont(":/fonts/manrope-bold");
    ...
    int paddingRight            = 100; // Fix spacing on splash screen, def=50,
    int paddingTop              = 50; // def=50
    int titleVersionVSpace      = 20; // def=17
    int titleCopyrightVSpace    = 40; // def=40

    float fontFactor            = 1.2; // def=1.0
    float devicePixelRatio      = 1.2; // def=1.0
...
//  QString copyrightText   = QString::fromUtf8(CopyrightHolders(strprintf("\xc2\xA9 %u-%u ", 2024, COPYRIGHT_YEAR)).c_str());
    ...
    QString font            = "Manrope-bold";
//  QString font            = QApplication::font().toString();
    // create a bitmap according to device pixelratio
    QSize splashSize(560*devicePixelRatio,360*devicePixelRatio); // def=480&320, 600*480
...
//  pixPaint.setPen(QColor(100,100,100));
    pixPaint.setPen(QColor(3, 252, 111));
...
// def gradient.setColorAt(0, QColor(52, 245, 198));
// def gradient.setColorAt(1, QColor(42, 115, 127));
...
//     gradient.setColorAt(1, QColor(247,247,247)); 
       ...
       pixPaint.fillRect(rGradient, gradient);
        ...
        // Testnet
        QRadialGradient gradient(QPoint(0, 0), splashSize.width() / devicePixelRatio);
// def  gradient.setColorAt(0, QColor(68, 73, 205));
// def  gradient.setColorAt(1, QColor(31, 22, 142));
    ...
    // draw the soteria icon, expected size of PNG: 1024x1024
    QRect rectIcon(QPoint(-35,0), QSize(310,310)); // def=-40,0

    const QSize requiredSize(1024,1024);
    QPixmap icon(":/icons/soterialogo");

    pixPaint.drawPixmap(rectIcon, icon);

    // check font size and drawing with. draw copyright stuff
    pixPaint.setFont(QFont(font, 33*fontFactor)); // def=33
    ...
    if(versionTextWidth > titleTextWidth+paddingRight-10) {
        pixPaint.setFont(QFont(font, 15*fontFactor)); // def=10
    ...
    {
        pixPaint.setFont(QFont(font, 15*fontFactor)); // def=10, LTC=15
    ...
    if(!titleAddText.isEmpty()) {
        QFont boldFont = QFont(font, 15*fontFactor); // def=10
    ...
    pixPaint.setFont(QFont(font, 15*fontFactor));
    pixPaint.drawText(220, 170, "More than just a blockchain!");
...
// def  Q_ARG(QColor, QColor(55,55,55)));         
