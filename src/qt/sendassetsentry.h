...
#ifndef SOTERIA_QT_SENDASSETSENTRY_H
#define SOTERIA_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending soterias.
...
#endif // SOTERIA_QT_SENDASSETSENTRY_H
