    ...
    platformStyle(_platformStyle)
{
    ...
    if (!_platformStyle->getImagesOnButtons()) {
        ...
        ui->showRequestButton->setIcon(_platformStyle->SingleColorIcon(":/icons/edit", COLOR_SOTERIA_18A7B7));
        ui->removeRequestButton->setIcon(_platformStyle->SingleColorIcon(":/icons/remove",COLOR_SOTERIA_18A7B7));
    }
...
void ReceiveCoinsDialog::copyURI()
{
    ...
    const QString uri = GUIUtil::formatSoteriaURI(submodel->entry(sel.row()).recipient);
