...
#ifndef SOTERIA_QT_SOTERIAUNITS_H
#define SOTERIA_QT_SOTERIAUNITS_H
...
/** Soteria unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SoteriaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SoteriaUnits(QObject *parent);
    ...
    //! Number of Soteriaios (1e-8) per unit
    static qint64 factor(int unit);
    //! Number of Soteriaios (1e-8) per unit for assets
    ...
    //! Return maximum number of base units (Soteriaios)
    static CAmount maxMoney();

private:
    QList<SoteriaUnits::Unit> unitlist;
};
typedef SoteriaUnits::Unit SoteriaUnit;

#endif // SOTERIA_QT_SOTERIAUNITS_H
