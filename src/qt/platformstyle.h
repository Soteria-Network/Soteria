...
#ifndef SOTERIA_QT_PLATFORMSTYLE_H
#define SOTERIA_QT_PLATFORMSTYLE_H
...
public:
    ...
    QColor Soteria_18A7B7() const;
    QColor Soteria_19827B() const;
    QColor Soteria_2B737F() const;
    QColor Soteria_34E2D6() const;
...
#endif // SOTERIA_QT_PLATFORMSTYLE_H
