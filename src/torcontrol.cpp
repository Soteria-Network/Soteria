...
static constexpr int TOR_COOKIE_SIZE = 32;
/** Size of client/server nonce for SAFECOOKIE */
static constexpr int TOR_NONCE_SIZE = 32;
/** For computing serverHash in SAFECOOKIE */
static const std::string TOR_SAFE_SERVERKEY = "Tor safe cookie authentication server-to-controller hash";
/** For computing clientHash in SAFECOOKIE */
static const std::string TOR_SAFE_CLIENTKEY = "Tor safe cookie authentication controller-to-server hash";
/** Exponential backoff configuration - initial timeout in seconds */
static constexpr float RECONNECT_TIMEOUT_START = 1.0f;
/** Exponential backoff configuration - growth factor */
static constexpr float RECONNECT_TIMEOUT_EXP = 1.5f;
...
/****** Soteria specific TorController implementation ********/
