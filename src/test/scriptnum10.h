...
#ifndef SOTERIA_TEST_SCRIPTNUM10_H
#define SOTERIA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Soteria Core 0.10.0, for cross-comparison.
 */
public:
