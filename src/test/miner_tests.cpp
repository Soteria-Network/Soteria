...
BOOST_FIXTURE_TEST_SUITE(miner_tests, TestingSetup)
    ...
    void TestPackageSelection(const CChainParams &chainparams, CScript scriptPubKey, std::vector<CTransactionRef> &txFirst)
    {
        ...
        tx.vout.resize(1);
        tx.vout[0].nValue = 24000000LL - 1000;
        // This tx has a low fee: 1000 soterios
        uint256 hashParentTx = tx.GetHash(); // save this txid for later use
        mempool.addUnchecked(hashParentTx, entry.Fee(1000).Time(GetTime()).SpendsCoinbase(true).FromTx(tx));

        // This tx has a medium fee: 10000 soterios
        tx.vin[0].prevout.hash = txFirst[1]->GetHash();
        tx.vout[0].nValue = 24000000LL - 10000;
        uint256 hashMediumFeeTx = tx.GetHash();
        mempool.addUnchecked(hashMediumFeeTx, entry.Fee(10000).Time(GetTime()).SpendsCoinbase(true).FromTx(tx));

        // This tx has a high fee, but depends on the first transaction
        tx.vin[0].prevout.hash = hashParentTx;
        tx.vout[0].nValue = 24000000LL - 1000 - 50000; // 240 soterio fee
        ...
        tx.vout[0].nValue = 24000000LL - 1000 - 50000; // 0 fee
        ...
        tx.vout[0].nValue = 24000000LL - 1000 - 50000 - feeToUse;
        ...
        tx.vout.resize(2);
        tx.vout[0].nValue = 24000000LL - 100000000;
        ...
        tx.vout[0].nValue = 24000000LL - 100000000 - feeToUse;
        ...
        tx.vout[0].nValue = 100000000 - 10000; // 10k soterio fee
