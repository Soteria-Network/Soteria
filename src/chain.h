...
#ifndef SOTERIA_CHAIN_H
#define SOTERIA_CHAIN_H
...
// MTP, N*T/20=360, /30-40=450, min 240, use 300-360, 7.5min max
/**
 * Maximum amount of time that a block timestamp is allowed to exceed the
 * current network-adjusted time before the block will be accepted.
 */
static const int64_t MAX_FUTURE_BLOCK_TIME = 36;
static const int64_t MAX_FUTURE_BLOCK_TIME_DGW = 36;
static const int64_t MAX_FUTURE_BLOCK_TIME_DALGO = 36;
