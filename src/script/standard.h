...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_SOTERIA_ASSET script that carries data
    /** SOTER END */
};
...
/**
 * Generate a Soteria scriptPubKey for the given CTxDestination. Returns a P2PKH
