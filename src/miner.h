...
#ifndef SOTERIA_MINER_H
#define SOTERIA_MINER_H
...
public:
    ...
    /** Construct a new block template with coinbase to scriptPubKeyIn */
     std::unique_ptr<CBlockTemplate> CreateNewBlock(const CScript& scriptPubKeyIn, bool fMineWitnessTx=true, const POW_TYPE powType=POW_TYPE_SOTERG);
private:
    // utility functions
