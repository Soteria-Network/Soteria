...
static const int64_t DEFAULT_MAX_TIP_AGE = 3 * 60 * 60 * 24; /** 144 blocks = 2160, in nReb is 18, in oReb is 36, at the start 6-24h, 72 blocks in LLC. 2160, for fast chains better to choose 72 than 144 conserv */
