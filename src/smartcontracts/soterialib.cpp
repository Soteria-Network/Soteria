...
{
    static const struct luaL_Reg soteria_main[] = {
        {"rpc_call", rpc_call},
    ...
    static const struct luaL_Reg soteria_assets[] = {
    ...
    static const struct luaL_Reg soteria_blockchain[] = {
    ...
    static const struct luaL_Reg soteria_addressindex[] = {
    ...
    static const struct luaL_Reg soteria_messages[] = {
    ...
    static const struct luaL_Reg soteria_mining[] = {
    ...
    static const struct luaL_Reg soteria_network[] = {
        {"addnode", addnode},
    ...
    static const struct luaL_Reg soteria_transcations[] = {
    ...
    static const struct luaL_Reg soteria_wallet[] = {
    ...
    lua_newtable(L); // create the soteria table

    lua_newtable(L);
    luaL_setfuncs(L, soteria_main, 0);
    lua_setfield(L, -2, "util");

    lua_newtable(L);
    luaL_setfuncs(L, soteria_assets, 0);
    lua_setfield(L, -2, "assets");

    lua_newtable(L);
    luaL_setfuncs(L, soteria_blockchain, 0);
    lua_setfield(L, -2, "blockchain");

    lua_newtable(L);
    luaL_setfuncs(L, soteria_addressindex, 0);
    lua_setfield(L, -2, "addressIndex");

    lua_newtable(L);
    luaL_setfuncs(L, soteria_messages, 0);
    lua_setfield(L, -2, "messages");

    lua_newtable(L);
    luaL_setfuncs(L, soteria_mining, 0);
    lua_setfield(L, -2, "mining");

    lua_newtable(L);
    luaL_setfuncs(L, soteria_network, 0);
    lua_setfield(L, -2, "network");

    lua_newtable(L);
    luaL_setfuncs(L, soteria_transcations, 0);
    lua_setfield(L, -2, "transcations");

    lua_newtable(L);
    luaL_setfuncs(L, soteria_wallet, 0);
    lua_setfield(L, -2, "localWallet");

    lua_setglobal(L, "soteria"); // assign the soteria table to global `soteria`
