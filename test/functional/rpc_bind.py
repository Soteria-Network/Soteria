...
"""Test running soteriad with the -rpcbind and -rpcallowip options."""

import socket
import sys
from test_framework.test_framework import SoteriaTestFramework, SkipTest
...
class RPCBindTest(SoteriaTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-342, "non-JSON HTTP response with '403 Forbidden' from server", self.run_allowip_test, ['1.0.0.0'], non_loopback_ip, default_port)
