...
class TestSoteriaCli(SoteriaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `soteria-cli getinfo`")
        ...
        self.log.info("Compare responses from `soteria-cli -getinfo` and the RPCs data is retrieved from.")
