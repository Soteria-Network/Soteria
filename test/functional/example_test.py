...
class BaseNode(NodeConnCB):
    ...
    def on_block(self, conn, message):
        ...
        message.block.calc_soterg()
        self.block_receive_map[message.block.calc_soterg] += 1
...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SoteriaTestFramework
    pass

class ExampleTest(SoteriaTestFramework):
    # Each functional test is a subclass of the SoteriaTestFramework class.
    ...
    def custom_method(self):
        ...
        SoteriaTestFramework class so other tests can use it."""
