...
class WalletAccountsTest(SoteriaTestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 Soterias
        ...
        expected_account_balances = {"": 1040}
        for account in accounts:
            expected_account_balances[account] = 0
        
        assert_equal(node.listaccounts(), expected_account_balances)
        
        assert_equal(node.getbalance(""), 1040)
