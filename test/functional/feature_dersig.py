...
class BIP66Test(SoteriaTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # soteriad is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and soteriad produces more specific reject
            # reasons.
