...
class ReplaceByFeeTest(SoteriaTestFramework):
    ...
    def test_doublespend_chain(self):
        ...
        chain_txids = []
        while remaining_value > 2 * COIN:
            remaining_value -= 0.2 * COIN
            tx = CTransaction()
        ...
        # child fees - 40 SOTER - so this attempt is rejected.
        dbl_tx = CTransaction()
