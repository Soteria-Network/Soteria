...
By default, soteriad will dump mempool on shutdown and
...
class MempoolPersistTest(SoteriaTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give soteriad a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent soteriad from writing mempool.dat to disk. Verify that `savemempool` fails")
