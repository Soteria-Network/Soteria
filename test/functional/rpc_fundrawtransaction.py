...
class RawTransactionsTest(SoteriaTestFramework):
    ...
    def run_test(self):
        ...
        raw_match = self.nodes[2].createrawtransaction([], {self.nodes[2].getnewaddress():10})
        ...
        assert_raises_rpc_error(-5, "changeAddress must be a valid soteria address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
