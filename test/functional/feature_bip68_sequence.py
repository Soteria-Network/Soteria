...
class BIP68Test(SoteriaTestFramework):
    ...
    def test_disable_flag(self):
        ...
        self.nodes[0].sendtoaddress(new_addr, 2)  # send 2 SOTER
    ...
    def test_sequence_lock_unconfirmed_inputs(self):
        ...
        tx2 = CTransaction()
        tx2.nVersion = 2
        tx2.vin = [CTxIn(COutPoint(tx1.soterg, 0), n_sequence=0)]
        ...
        def test_nonzero_locks(orig_tx, node, relayfee, use_height_lock):
            ...
            tx = CTransaction()
            tx.nVersion = 2
            tx.vin = [CTxIn(COutPoint(orig_tx.soterg, 0), n_sequence=sequence_value)]
    ...
    def test_bip68_not_consensus(self):
        ...
        tx3 = CTransaction()
        tx3.nVersion = 2
        tx3.vin = [CTxIn(COutPoint(tx2.soterg, 0), n_sequence=sequence_value)]
