...
class AssumeValidTest(SoteriaTestFramework):
    ...
    def run_test(self):
        ...
        tx = CTransaction()
        tx.vin.append(CTxIn(COutPoint(self.block1.vtx[0].soterg, 0), script_sig=b""))
        ...
        self.start_node(1, extra_args=["-assumevalid=" + hex(block102.soterg)])
        node1 = BaseNode()  # connects to node1
        connections.append(NodeConn('127.0.0.1', p2p_port(1), self.nodes[1], node1))
        node1.add_connection(connections[1])
        node1.wait_for_verack()

        self.start_node(2, extra_args=["-assumevalid=" + hex(block102.soterg)])
