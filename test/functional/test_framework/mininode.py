...
"""
Soteria P2P network half-a-node.
...
class NodeConnCB:
    """Callback and helper functions for P2P connection to a soteriad node.
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest", services=NODE_NETWORK, send_version=True):
        ...
        logger.info('Connecting to Soteria Node: %s:%d' % (self.dstaddr, self.dstport))
