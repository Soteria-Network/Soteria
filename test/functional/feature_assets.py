...
class AssetTest(SoteriaTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("SOTERIA1", 1000)
        n0.issue("SOTERIA2", 1000)
        n0.issue("SOTERIA3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="SOTERIA*", verbose=False, count=2, start=-2)
        ...
        soteria_assets = n0.listassets(asset="SOTERIA*", verbose=False, count=2, start=-2)
        assert_equal(len(soteria_assets), 2)
        assert_equal(soteria_assets[0], "SOTERIA2")
        assert_equal(soteria_assets[1], "SOTERIA3")
        self.sync_all()
