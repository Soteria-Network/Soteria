...
#Set this to your soteria-cli program
cli = "soteria-cli"

#mode = "-testnet"
mode = ""
rpc_port = 8323
#Set this information in your soteria.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
	...
	for i in range(start_block,blockheight):
	    ...
	    for tx in txs:
	        ...
	        for vout in tx_detail.get('vout'):
	            if (vout.get('scriptPubKey').get('asm')[86:98] == "OP_SOTER_ASSET"):
	                print_debug("Found OP_SOTER_ASSET")
...
def monitor_zmq():
	...
	print("Getting Soteria msgs")
	socket.connect("tcp://localhost:8323")
