...
(define* (make-soteria-cross-toolchain target
                                       #:key
...
desirable for building Soteria Core release binaries."
...
(define glibc-2.27/soteria-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-soteria-cross-toolchain target
                                                      #:base-libc glibc-2.27/soteria-patched
