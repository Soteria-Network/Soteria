...
"""
    ...
    Soteria should be started with the command line arguments:
        soteriad -testnet -daemon \
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND SOTER issuance at " + str(pos))
				print("After SOTER: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND SOTER something at " + str(pos))
			start += pos+8
			print(astr)
